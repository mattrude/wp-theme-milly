...
<div id="exif">
  <h3 class='comment-title exif-title'>Images EXIF Data</h3>
  <div id="exif-data">
   <?php
...
<div id="exif-lable">
  <?php // EXIF Titles
  echo "<p><span>Date Taken: </span>";
  echo "<p><span>Camera: </span>";
  echo "<p><span>Focal Length: </span>";
  echo "<p><span>Aperture: </span>";
  echo "<p><span>ISO: </span>";
  echo "<p><span>Shutter Speed: </span>"; ?>
</div>
